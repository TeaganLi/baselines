...
def ppo_arg_parser():
    ...
    parser.add_argument('--lam', type=float, default=0.95, help='advantage estimation discouting factor')
...
def common_arg_parser():
    ...
    parser.add_argument('--env_type', help='type of environment, used when the environment type cannot be automatically determined', type=str, default="custom")
    ...
    parser.add_argument('--save_video_interval', help='Save video every x steps (0 = disabled)', default=1, type=int)
